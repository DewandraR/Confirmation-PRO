            ...
            <div class="max-w-md mx-auto text-center">
                <div class="mb-2 md:mb-3">
                    <img src="{{ asset('images/kmi.jpg') }}" alt="Company Logo"
                        class="mx-auto w-14 h-14 md:w-20 md:h-20 object-contain rounded-xl p-0.5 bg-white">
                </div>
    ...
    <div class="px-4 py-6 mt-4 md:px-6 md:py-10 md:mt-6">
        <div class="w-full max-w-md mx-auto bg-white rounded-3xl shadow-xl border border-slate-200/50 overflow-hidden">
            <div class="p-6 md:p-8 space-y-4">
                ...
                <form method="POST" action="{{ route('login.store') }}" class="space-y-5 md:space-y-6" id="loginForm"
                    autocomplete="off">
                    @csrf
                            ...
                            <div
                                ...
                                <div class="flex-shrink-0">
                                    <div class="w-6 h-6 bg-slate-100 rounded-lg flex items-center justify-center">
                                        <svg class="w-3.5 h-3.5 text-slate-600" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <input id="sap_id" name="sap_id" type="text" inputmode="text" autocomplete="username"
                        ...
                        <div class="relative group">
                            <div
                                ...
                                <button type="button" id="togglePass"
                                    class="text-xs text-slate-500 hover:text-slate-700 px-2">Tampil</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="w-full max-w-md mx-auto mt-3">
            <div class="text-xs text-slate-600 bg-slate-50 border border-slate-200 rounded-xl px-4 py-3">
                ...
                <ul class="list-disc pl-5 space-y-1">
                    ...
                    <li>Jika lokasi tidak akurat, <b>coba matikan lalu nyalakan kembali Wi-Fi/data seluler</b>, kemudian
                        refresh browser.</li>
