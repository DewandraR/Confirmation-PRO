        ...
        <div class="relative px-4 py-6">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex items-center gap-2 mb-4">
                    <a id="back-link" href="{{ route('scan') }}"
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
                            ...
                            <div class="flex items-center gap-6 mt-3 sm:mt-0">
                                <div class="flex items-center gap-2">
                                    <label for="budat-input-text" class="text-xs text-slate-500 font-bold">Posting
                                        Date</label>

                                    {{-- hidden: yyyy-mm-dd (dibaca JS) --}}
                                    <input type="date" id="budat-input" value="{{ now()->format('Y-m-d') }}"
                                        max="{{ now()->format('Y-m-d') }}" class="sr-only">

                                    {{-- terlihat: dd/mm/yyyy (user input) --}}
                                    <input type="text" id="budat-input-text" value="{{ now()->format('d/m/Y') }}"
                                        inputmode="numeric" pattern="\d{2}/\d{2}/\d{4}" placeholder="hh/bb/tttt"
                        ...
                        <div class="overflow-auto max-h-[70vh] rounded-xl border border-slate-200">
                            <table class="w-full data-table">
                                <thead class="bg-green-700/90 sticky top-0 z-10">
                                    <tr>
                                        <th
                                            class="px-3 py-3 text-center text-xs font-medium text-white uppercase tracking-wider border-b border-green-400 sticky left-0 bg-green-700/90">
                                        ...
                                        <th
                                            class="px-3 py-3 text-center text-xs font-medium text-white uppercase tracking-wider border-b border-green-400 w-16">
                                            No</th>
                                        <th
                                        ...
                                        <th
                                            class="px-3 py-3 text-center text-xs font-medium text-white uppercase tracking-wider border-b border-green-400 min-w-[110px]">
                                            Qty PRO</th>
                                        {{-- ====== AKHIR TAMBAHAN ====== --}}
                                        ...
                                        <th
                                            ...
                                            Finish Date</th>
                                        <th
                                            class="px-3 py-3 text-left text-xs font-medium text-white uppercase tracking-wider border-b border-green-400 min-w-[200px]">
                                            Deskripsi FG
                                        </th>
                                        <th
                                            class="px-3 py-3 text-left text-xs font-medium text-white uppercase tracking-wider border-b border-green-400 min-w-[120px]">
                                            Material
                                        </th>
                                        <th
                                            class="px-3 py-3 text-left text-xs font-medium text-white uppercase tracking-wider border-b border-green-400 min-w-[200px]">
    ...
    <div id="warning-modal"
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200/50 w-full max-w-sm overflow-hidden">
            <div id="warning-header"
                class="bg-gradient-to-r from-yellow-50 to-yellow-100 px-4 py-3 border-b border-yellow-200">
            ...
            <div class="px-4 py-3 bg-slate-50 border-t border-slate-200 flex justify-end">
                <button id="warning-ok-button" type="button"
                    class="px-4 py-2 rounded-lg bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-semibold transition-colors">OK</button>
            </div>
        </div>
    </div>
